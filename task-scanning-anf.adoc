...
Wenn das Azure NetApp Files -System, das Sie scannen möchten, nicht bereits in der NetApp Console als System vorhanden ist,link:https://docs.netapp.com/us-en/storage-management-azure-netapp-files/task-quick-start.html["fügen Sie es auf der Seite „Systeme“ hinzu"^] .
