...
. Identifizieren Sie das System, auf dem Sie das Scannen aktivieren möchten.
...
+
Siehe <<Aktivieren oder Deaktivieren von Scans auf Volumes>> für Details.



.Ergebnis
Data Classification beginnt mit dem Scannen der von Ihnen im System ausgewählten Volumes. Die Ergebnisse sind im Compliance-Dashboard verfügbar, sobald Data Classification die ersten Scans abgeschlossen hat. Die Dauer hängt von der Datenmenge ab – sie kann einige Minuten oder Stunden betragen. Sie können den Fortschritt des ersten Scans verfolgen, indem Sie zur Systemübersichtsseite im Menü *Konfiguration* navigieren. Data Classification zeigt für jeden Scan einen Fortschrittsbalken an. Sie können mit dem Mauszeiger über den Fortschrittsbalken fahren, um die Anzahl der gescannten Dateien im Verhältnis zur Gesamtanzahl der Dateien im Volume zu sehen.
