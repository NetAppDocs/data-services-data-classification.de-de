...
summary: Die über die Web-Benutzeroberfläche verfügbaren NetApp Datenklassifizierungsfunktionen sind auch über die API verfügbar. 
---
= NetApp Datenklassifizierungs-APIs
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Die über die Web-Benutzeroberfläche verfügbaren NetApp Datenklassifizierungsfunktionen sind auch über die REST-API verfügbar.
...
Mit den APIs in der Swagger-Dokumentation können Sie suchen, Daten aggregieren, Ihre Scans verfolgen und Aktionen wie Kopieren, Verschieben und mehr ausführen.
