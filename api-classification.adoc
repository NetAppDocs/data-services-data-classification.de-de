...
Um auf Swagger zuzugreifen, benötigen Sie die IP-Adresse Ihrer Data Classification-Instanz. Bei einer Cloud-Bereitstellung verwenden Sie die öffentliche IP-Adresse. Anschließend müssen Sie auf diesen Endpunkt zugreifen:
