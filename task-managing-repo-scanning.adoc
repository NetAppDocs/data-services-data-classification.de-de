...
. Um den Scan-Typ für einzelne Buckets, Freigaben oder Volumes zu ändern, die Registerkarte **Aktive Scans** auswählen. Die entsprechenden Filter anwenden, um die Ressourcen zu identifizieren, die geändert werden sollen.
+
image:screenshot_compliance_config_button.png["Ein Screenshot, der zeigt, wie Sie die Schaltfläche „Konfiguration“ für ein System auswählen."]

+
In der Spalte „Scantyp“ die entsprechende Ressource auswählen und auf **Nur Mapping** oder **Vollständiger Scan** ändern.
...
.Schritte
. Wählen Sie im Menü „Datenklassifizierung“ die Option „Konfiguration“ aus.
. Die Registerkarte **Aktive Scans** auswählen.
. Optional können die entsprechenden Filter angewendet werden, um die Ressourcen zu identifizieren, die geändert werden sollen. Die Ressourcen, die priorisiert werden sollen, auffinden. Im Aktionsmenü die Option  `...`*Scan priorisieren* auswählen.
...
. Wählen Sie im Menü „Datenklassifizierung“ die Option „Konfiguration“ aus.
. Die Registerkarte **Aktive Scans** auswählen.
. Optional können die entsprechenden Filter angewendet werden, um die Ressourcen zu identifizieren, die geändert werden sollen. Die Ressourcen, die pausiert werden sollen, identifizieren. Für jede Ressource die Aktion-Menü `...` Option auswählen und dann *Scan pausieren*.
+
