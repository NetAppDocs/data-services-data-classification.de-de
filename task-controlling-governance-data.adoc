...
summary: Mithilfe der Datenklassifizierung können Sie Speicherkosten senken, indem Sie veraltete Daten, doppelte Dateien und große Dateien identifizieren und diese anschließend entfernen oder in kostengünstigeren Objektspeicher auslagern. 
---
= Zeigen Sie Governance-Details zu Organisationsdaten mit NetApp Data Classification an
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
. Wählen Sie in jedem Bereich „Einsparpotenziale“ des Governance-Dashboards die Option *Speicher optimieren*, um die gefilterten Ergebnisse auf der Untersuchungsseite anzuzeigen. Um Daten zu finden, die Sie löschen oder in kostengünstigeren Speicher auslagern sollten, untersuchen Sie die _Saving Opportunities_.
+
...
.Schritte
. Wählen Sie unter „Datenklassifizierung“ *Governance* aus.
. Wählen Sie in der Kachel „Berichte“ die Schaltfläche **Herunterladen** in der Überschrift „Übersichtsbericht zur vollständigen Datenzuordnung“.
+
