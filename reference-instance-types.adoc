...
[role="lead"]
NetApp Data Classification Software muss auf einem Host ausgeführt werden, der bestimmte Anforderungen an Betriebssystem, RAM und Software erfüllt. Wenn Sie Data Classification in der Cloud bereitstellen, empfehlen wir die Verwendung eines Systems mit den Eigenschaften „large“, um die volle Funktionalität zu gewährleisten.
