...
NOTE: Konformitätsdetails auf Dateiebene sind nur verfügbar, wenn Sie einen vollständigen Klassifizierungsscan durchführen. Reine Mapping-Scans liefern keine Details auf Dateiebene.
...
+
image:screenshot_compliance_investigation_page.png["Ein Screenshot mit detaillierten Informationen, die in Dateien gefunden wurden, nachdem Sie auf „Ergebnisse untersuchen“ geklickt haben."]
