...
---
= Zeigen Sie Compliance-Details zu privaten Organisationsdaten mit NetApp Data Classification an
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
NOTE: Detaillierte Informationen zur Konformität auf Dateiebene sind nur bei einer vollständigen Klassifizierungsprüfung verfügbar. Reine Kartenprüfungen liefern keine Details auf Dateiebene.
...
+
image:screenshot_compliance_investigation_page.png["Ein Screenshot mit detaillierten Informationen, die in Dateien nach Auswahl von „Ergebnisse untersuchen“ gefunden wurden."]

+
image:screenshot_compliance_investigation_page_directory.png["Ein Screenshot mit detaillierten Informationen, die in Verzeichnissen nach Auswahl von Investigate Results gefunden wurden."]
...
. Untersuchen Sie die Daten, indem Sie suchen, sortieren, Details für eine bestimmte Datei erweitern, *Untersuchungsergebnisse* auswählen, um maskierte Informationen anzuzeigen, oder indem Sie die Dateiliste herunterladen.
