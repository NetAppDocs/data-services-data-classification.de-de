...
summary: Wenn Gruppen-IDs Dateien oder Ordnern in NFS-Dateifreigaben zugewiesen werden, definieren sie die Berechtigungen für die jeweilige Datei oder den jeweiligen Ordner. Falls Gruppen-IDs nicht auf die Berechtigungsstufe „Open to Organization“ eingestellt sind, können Sie diese Berechtigung der GID hinzufügen, sodass alle Dateien und Ordner mit dieser GID als „open to the organization“ gelten. 
---
