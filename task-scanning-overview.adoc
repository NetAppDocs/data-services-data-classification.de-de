...
Nach dem ersten Scan durchsucht Data Classification Ihre Daten kontinuierlich im Round-Robin-Verfahren, um inkrementelle Änderungen zu erkennen. Scans werden täglich automatisch durchgeführt. Data Classification führt Scans in Sechsergruppen durch; Sie können Scans pausieren oder link:task-managing-repo-scanning.html#prioritize-scans["manuell priorisieren"].
...
TIP: Eine reine Kartenanalyse kann hilfreich sein, um einen Überblick über Ihre Daten zu erhalten. Mit diesem Überblick auf hoher Ebene kann anschließend entschieden werden, bei welchen Datenquellen vollständige Analysen durchgeführt werden sollen.
