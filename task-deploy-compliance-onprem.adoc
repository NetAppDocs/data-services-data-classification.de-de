...
summary: Um NetApp Data Classification auf einem Linux-Host in Ihrem Netzwerk oder auf einem Linux-Host in der Cloud mit Internetzugang zu installieren, müssen Sie den Linux-Host manuell in Ihrem Netzwerk oder in der Cloud bereitstellen. 
---
...
Für die Installation und Nutzung von NetApp Data Classification ist ein Console Agent erforderlich. In den meisten Fällen haben Sie wahrscheinlich bereits einen Console Agent eingerichtet, bevor Sie NetApp Data Classification aktivieren.
...
In den meisten Situationen wird Data Classification auf einem Einzelhost-System installiert. Dies ist nicht derselbe VM-Host wie der Console Agent. <<Single-Host-Installation für typische Konfigurationen,Sehen Sie sich diese Schritte hier an>>.
...
.Schritte
. Laden Sie die Data Classification-Software von der https://mysupport.netapp.com/site/products/all/details/cloud-data-sense/downloads-tab/["NetApp Support Site"^] herunter. Wählen Sie die Datei mit dem Namen *DATASENSE-INSTALLER-<version>.tar.gz* aus.
