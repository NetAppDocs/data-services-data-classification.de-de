...
summary: 'NetApp bietet auf verschiedene Weise Support für die NetApp Console . Umfangreiche kostenlose Self-Support-Optionen wie Knowledgebase-Artikel (KB) und ein Community-Forum stehen jederzeit zur Verfügung. Ihre Support-Registrierung beinhaltet technischen Remote-Support per Web-Ticketing.' 
---
