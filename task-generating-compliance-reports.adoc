...
---
= Compliance-Berichte in NetApp Data Classification anzeigen
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[NOTE]
====
* Compliance-Berichte sind nur verfügbar, wenn Sie eine vollständige Klassifizierungsprüfung Ihrer Datenquellen durchführen. Datenquellen, die lediglich einer Zuordnungsprüfung unterzogen wurden, können nur den Datenzuordnungsbericht generieren.
