...
---
= Untersuchen Sie Daten in Ihrem Unternehmen mit NetApp Data Classification
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Das Dashboard „Data Investigation“ zeigt Einblicke auf Datei- und Verzeichnisebene in Ihre Daten und ermöglicht es Ihnen, Ergebnisse zu sortieren und zu filtern. Die Seite „Data Investigation“ präsentiert Einblicke in Metadaten und Berechtigungen von Dateien und Verzeichnissen sowie die Identifizierung doppelter Dateien. Mit Einblicken auf Datei-, Verzeichnis- und Datenbankebene können Sie Maßnahmen ergreifen, um die Compliance Ihres Unternehmens zu verbessern und Speicherplatz zu sparen. Die Seite „Data Investigation“ unterstützt außerdem link:task-copy-move.html["Dateien verschieben, kopieren und löschen"].


NOTE: Um von der Untersuchungsseite zu profitieren, müssen Sie einen vollständigen Klassifizierungsscan Ihrer Datenquellen durchführen. Datenquellen, bei denen nur ein reiner Mapping-Scan durchgeführt wurde, zeigen keine Details auf Dateiebene an.
...
| Anzahl der Kennungen | Wählen Sie den Bereich der erkannten sensiblen Kennungen pro Datei aus. Dies umfasst personenbezogene Daten und sensible personenbezogene Daten. Beim Filtern in Verzeichnissen summiert die Datenklassifizierung die Treffer aus allen Dateien in jedem Ordner und Unterordner. HINWEIS: Die Dezember 2023 (Version 1.26.6) Veröffentlichung hat die Option entfernt, die Anzahl personenbezogener Daten (PII) nach Verzeichnissen zu berechnen. 
...
TIP: Nach dem Filtern der Daten können Sie link:task-copy-move.html["unstrukturierte Dateien kopieren, verschieben und löschen"] verwenden, um die Compliance zu verbessern oder den Speicher zu optimieren.
...
[[whats-included-in-the-downloadable-report]]
...
* link:task-copy-move.html["Daten aus dem Investigation Dashboard kopieren, verschieben und löschen"]
