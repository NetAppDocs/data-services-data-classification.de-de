...
Der reine Kartenscan erwärmt die kalten Daten nicht: Sie bleiben kalt und verbleiben im Objektspeicher. Führt man hingegen einen vollständigen Scan durch, können bestimmte Konfigurationen dazu führen, dass die kalten Daten erwärmt werden.
