...
. Wählen Sie **Datenklassifizierung deinstallieren**.
...
. Geben Sie im Dialogfeld „uninstall“ ein, um die Datenklassifizierungsinstanz vom Console-Agenten zu trennen. Wählen Sie **Uninstall**, um zu bestätigen.
