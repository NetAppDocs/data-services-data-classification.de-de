...
summary: Bei Bedarf können Sie die Datenklassifizierung daran hindern, Systeme, Datenbanken oder Dateifreigabegruppen zu scannen. 
---
...
TIP: Sie können Scans für ein System auch über das Bedienfeld „Dienste“ deaktivieren, wenn Sie das System auswählen.
