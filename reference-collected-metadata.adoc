...
Bei Bedarf können Sie diese Ergebnisse in einen Bericht exportieren, sodass Sie sehen können, welche Dateien aufgrund von Berechtigungen gescannt werden und welche nicht. link:task-investigate-data.html#data-investigation-report["Erfahren Sie mehr über den Data Investigation Report"^] .
